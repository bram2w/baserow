...
We strongly recommend you use our `baserow/baserow:1.34.5` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:1.34.5`
    and `baserow/web-frontend:1.34.5` images.
...
* The all-in-one Baserow image `baserow/baserow:1.34.5`
...
* Our standalone `baserow/backend:1.34.5` and `baserow/web-frontend:1.34.5` images with
...
If you are using the `baserow/backend:1.34.5` image then you can do this by adding
