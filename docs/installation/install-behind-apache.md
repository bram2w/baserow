...
We strongly recommend you use our `baserow/baserow:1.32.3` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:1.32.3`
    and `baserow/web-frontend:1.32.3` images.
...
* The all-in-one Baserow image `baserow/baserow:1.32.3`
...
* Our standalone `baserow/backend:1.32.3` and `baserow/web-frontend:1.32.3` images with
...
If you are using the `baserow/backend:1.32.3` image then you can do this by adding
