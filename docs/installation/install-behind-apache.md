...
We strongly recommend you use our `baserow/baserow:1.24.0` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:1.24.0`
    and `baserow/web-frontend:1.24.0` images.
...
* The all-in-one Baserow image `baserow/baserow:1.24.0`
...
* Our standalone `baserow/backend:1.24.0` and `baserow/web-frontend:1.24.0` images with
...
If you are using the `baserow/backend:1.24.0` image then you can do this by adding
