...
We strongly recommend you use our `baserow/baserow:1.32.1` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:1.32.1`
    and `baserow/web-frontend:1.32.1` images.
...
* The all-in-one Baserow image `baserow/baserow:1.32.1`
...
* Our standalone `baserow/backend:1.32.1` and `baserow/web-frontend:1.32.1` images with
...
If you are using the `baserow/backend:1.32.1` image then you can do this by adding
