...
We strongly recommend you use our `baserow/baserow:1.24.2` image or the example
...
>
> * Your own container setup with our single service `baserow/backend:1.24.2`
    and `baserow/web-frontend:1.24.2` images.
...
* The all-in-one Baserow image `baserow/baserow:1.24.2`
...
* Our standalone `baserow/backend:1.24.2` and `baserow/web-frontend:1.24.2` images with
...
If you are using the `baserow/backend:1.24.2` image then you can do this by adding
