export default {
  ...
  formulaFunctions: {
    ...
    concatDescription: '@todo',
    addDescription: '@todo',
    minusDescription: '@todo',
    multiplyDescription: '@todo',
    divideDescription: '@todo',
    equalDescription: '@todo',
    ifDescription: '@todo',
    toTextDescription: '@todo',
    datetimeFormatDescription: '@todo',
    toNumberDescription: '@todo',
    fieldDescription: '@todo',
    lookupDescription: '@todo',
    isBlankDescription: '@todo',
    tDescription: '@todo',
    notDescription: '@todo',
    greaterThanDescription: '@todo',
    greaterThanOrEqualDescription: '@todo',
    lessThanDescription: '@todo',
    lessThanOrEqualDescription: '@todo',
    toDateDescription: '@todo',
    dayDescription: '@todo',
    dateDiffDescription: '@todo',
    andDescription: '@todo',
    orDescription: '@todo',
    dateIntervalDescription: '@todo',
    replaceDescription: '@todo',
    searchDescription: '@todo',
    rowIdDescription: '@todo',
    lengthDescription: '@todo',
    reverseDescription: '@todo',
    notEqualDescription: '@todo',
    countDescription: '@todo',
    containsDescription: '@todo',
    leftDescription: '@todo',
    rightDescription: '@todo',
    trimDescription: '@todo',
    regexReplaceDescription: '@todo',
    greatestDescription: '@todo',
    leastDescription: '@todo',
    monthDescription: '@todo',
    yearDescription: '@todo',
    secondDescription: '@todo',
    whenEmptyDescription: '@todo',
    anyDescription: '@todo',
    everyDescription: '@todo',
    maxDescription: '@todo',
    minDescription: '@todo',
    joinDescription: '@todo',
    stddevPopDescription: '@todo',
    stddevSampleDescription: '@todo',
    varianceSampleDescription: '@todo',
    variancePopDescription: '@todo',
    avgDescription: '@todo',
    sumDescription: '@todo',
    filterDescription: '@todo',
  },
}
