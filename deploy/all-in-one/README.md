...
```bash
docker run -v baserow_data:/baserow/data -p 80:80 -p 443:443 baserow/baserow:1.29.2
```
...
The `baserow/baserow:1.29.2` image by default runs all of Baserow's various services in
