...
| `global.baserow.assistantLLMModel`                                 | Configure the AI assistant fallback model for an unconfigured or invalid Kuma selection. Explicit disables prevent fallback. | `""`                    |
