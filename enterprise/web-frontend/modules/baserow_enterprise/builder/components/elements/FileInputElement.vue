    ...
    >
      <template #help-text>
        <FormattedText
          ...
          :format="element.help_text?.format"
          preset="block"
        />
      </template>
    </ABFileInput>
...
export default {
  ...
  props: {
    /**
     * @type {Object}
     * @property {Object} label - The input's label formula, carrying its
     *   (plain/markdown) `format`.
     * @property {string} default_url - Initial url(s).
     * @property {string} default_name - Initial Name(s).
     * @property {Object} help_text - The help text formula, carrying its
     *   (plain/markdown) `format`.
