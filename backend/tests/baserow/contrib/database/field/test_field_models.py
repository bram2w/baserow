...
def test_date_field_get_python_format():
    ...
    eu_time_24 = DateField(date_format='EU', date_include_time=True,
                           date_time_format='24')
    us_time_24 = DateField(date_format='US', date_include_time=True,
                           date_time_format='24')
    iso_time_24 = DateField(date_format='ISO', date_include_time=True,
                            date_time_format='24')

    eu_time_12 = DateField(date_format='EU', date_include_time=True,
                           date_time_format='12')
    us_time_12 = DateField(date_format='US', date_include_time=True,
                           date_time_format='12')
    iso_time_12 = DateField(date_format='ISO', date_include_time=True,
                            date_time_format='12')
