...
def test_list_views(api_client, data_fixture):
    ...
    response = api_client.get(
        reverse('api_v0:database:views:list', kwargs={'table_id': table_1.id}), **{
    ...
    response = api_client.get(
        reverse('api_v0:database:views:list', kwargs={'table_id': 999999}), **{
            'HTTP_AUTHORIZATION': f'JWT {token}'
        }
    )
...
def test_create_view(api_client, data_fixture):
    ...
    response = api_client.post(
        reverse('api_v0:database:views:list', kwargs={'table_id': table.id}),
        {
            'name': 'Test 1',
            'type': 'NOT_EXISTING'
        },
    ...
    response = api_client.post(
        reverse('api_v0:database:views:list', kwargs={'table_id': 99999}),
