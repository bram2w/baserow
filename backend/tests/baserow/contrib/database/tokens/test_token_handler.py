...
def test_update_token_permission(data_fixture):
    ...
    with pytest.raises(DatabaseDoesNotBelongToGroup):
        handler.update_token_permissions(user=user, token=token_1,
...
def test_has_table_permission(data_fixture):
    ...
    handler.update_token_permissions(user=user, token=token, create=True, read=True,
                                     update=True, delete=True)
    handler.update_token_permissions(user=user, token=token_other_group, create=True,
                                     read=True, update=True, delete=True)
    handler.update_token_permissions(user=user_3, token=token_user_3, create=True,
                                     read=True, update=True, delete=True)
    handler.update_token_permissions(user=user, token=token_group_3, create=True,
                                     read=True, update=True, delete=True)
    ...
    handler.update_token_permissions(user=user, token=token, create=False, read=True,
    ...
    handler.update_token_permissions(user=user, token=token, create=[database_1],
    ...
    handler.update_token_permissions(user=user, token=token, create=False,
                                     read=False, update=[table_3], delete=False)
    ...
    handler.update_token_permissions(user=user, token=token, create=True,
                                     read=[database_2], update=[table_3], delete=False)
    ...
    handler.update_token_permissions(user=user, token=token, create=False,
                                     read=[database_1], update=False, delete=True)
