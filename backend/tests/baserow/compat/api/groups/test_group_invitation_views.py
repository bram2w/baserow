...
def test_list_group_invitations(api_client, data_fixture, group_compat_timebomb):
    ...
    response = api_client.get(
        reverse("api:groups:invitations:list", kwargs={"group_id": workspace_2.id}),
        HTTP_AUTHORIZATION=f"JWT {token_1}",
    )
    ...
    response = api_client.get(
        reverse("api:groups:invitations:list", kwargs={"group_id": workspace_1.id}),
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_create_group_invitation(api_client, data_fixture, group_compat_timebomb):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    user_2, token_2 = data_fixture.create_user_and_token(email="test2@test.nl")
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_get_group_invitation(api_client, data_fixture, group_compat_timebomb):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    user_2, token_2 = data_fixture.create_user_and_token(email="test2@test.nl")
    user_3, token_3 = data_fixture.create_user_and_token(email="test3@test.nl")
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_update_group_invitation(api_client, data_fixture, group_compat_timebomb):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    user_2, token_2 = data_fixture.create_user_and_token(email="test2@test.nl")
    user_3, token_3 = data_fixture.create_user_and_token(email="test3@test.nl")
    workspace_1 = data_fixture.create_workspace()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_delete_group_invitation(api_client, data_fixture, group_compat_timebomb):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    user_2, token_2 = data_fixture.create_user_and_token(email="test2@test.nl")
    user_3, token_3 = data_fixture.create_user_and_token(email="test3@test.nl")
    workspace_1 = data_fixture.create_workspace()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_accept_group_invitation(api_client, data_fixture, group_compat_timebomb):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    user_2, token_2 = data_fixture.create_user_and_token(email="test2@test.nl")
    workspace_1 = data_fixture.create_workspace()
    invitation = data_fixture.create_workspace_invitation(
    ...
    response = api_client.post(
        reverse(
            ...
            kwargs={"group_invitation_id": 99999},
        ),
        HTTP_AUTHORIZATION=f"JWT {token_1}",
    )
    response_json = response.json()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_reject_group_invitation(api_client, data_fixture, group_compat_timebomb):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    user_2, token_2 = data_fixture.create_user_and_token(email="test2@test.nl")
    workspace_1 = data_fixture.create_workspace()
    invitation = data_fixture.create_workspace_invitation(
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_get_group_invitation_by_token(api_client, data_fixture, group_compat_timebomb):
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_when_workspace_is_trashed_so_is_invitation(
    data_fixture, api_client, group_compat_timebomb
):
    user_1, token_1 = data_fixture.create_user_and_token(email="test1@test.nl")
    ...
    response = api_client.get(
        reverse(
            "api:groups:invitations:list",
            kwargs={"group_id": trashed_workspace.id},
        ),
        HTTP_AUTHORIZATION=f"JWT {token_1}",
    )
    assert response.status_code == HTTP_404_NOT_FOUND
    ...
    response = api_client.get(
        reverse(
            "api:groups:invitations:list",
            kwargs={"group_id": visible_workspace.id},
        ),
        HTTP_AUTHORIZATION=f"JWT {token_1}",
    )
    assert response.status_code == HTTP_200_OK
