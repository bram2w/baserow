...
def test_deleting_a_group_moves_it_to_the_trash_and_hides_it(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
    workspace_to_delete = data_fixture.create_workspace(user=user)

    url = reverse("api:groups:item", kwargs={"group_id": workspace_to_delete.id})
    ...
    response = api_client.get(
        reverse(
            "api:trash_compat:contents",
            kwargs={
                "group_id": workspace_to_delete.id,
            },
        ),
        HTTP_AUTHORIZATION=f"JWT {token}",
    )
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_can_restore_a_deleted_trash_item(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
    workspace_to_delete = data_fixture.create_workspace(user=user)
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_cant_restore_a_non_existent_trashed_item(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_cant_restore_a_trashed_item_with_a_missing_parent(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
...
def test_cant_restore_a_trash_item_marked_for_perm_deletion(
    api_client, data_fixture, settings, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
    workspace_to_delete = data_fixture.create_workspace(user=user)
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_can_get_trash_structure(api_client, data_fixture, group_compat_timebomb):
    user, token = data_fixture.create_user_and_token()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_getting_a_non_existent_workspace_returns_404(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_getting_a_app_for_diff_workspace_returns_400(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
    workspace = data_fixture.create_workspace(user=user)
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_can_get_trash_contents_for_undeleted_workspace(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_can_get_trash_contents_for_undeleted_app(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_emptying_a_non_existent_workspace_returns_404(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_emptying_a_app_for_diff_workspace_returns_400(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
    workspace = data_fixture.create_workspace(user=user)
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_emptying_a_trashed_app_marks_it_for_perm_deletion(
    api_client, data_fixture, group_compat_timebomb
):
    user, token = data_fixture.create_user_and_token()
    workspace = data_fixture.create_workspace(user=user)
...
@pytest.mark.django_db
@pytest.mark.disabled_in_ci
def test_cant_delete_same_item_twice(api_client, data_fixture, group_compat_timebomb):
    user, token = data_fixture.create_user_and_token()
    workspace = data_fixture.create_workspace(user=user)
