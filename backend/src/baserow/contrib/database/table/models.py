...
from .cache import table_model_cache_entry_key
...
class Table(
    ...
    @property
    def cache_key(self):
        return table_model_cache_entry_key(self.id)
    ...
    def get_model(
        ...
        if field_attrs is None or not use_cache:
            ...
            if use_cache:
                ...
                generated_models_cache.set(self.cache_key, field_attrs, timeout=None)
